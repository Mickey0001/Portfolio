...
const Testimonials = () => (
	<div className="container">
     ...
     <div className="carousel-item col-md-12 col-sm-12" align="center">
        ...
        <div className="row">
        <div className="carousel-item col-md-12 col-sm-12" align="center">
                    <p className="text-center ClientQuote">"Punctual and emphatic towards people who are not too tech savvy. <br/> Mirza was very kind and pleasant to work with."</p>
