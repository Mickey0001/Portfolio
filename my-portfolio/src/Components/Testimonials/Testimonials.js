...
const Testimonials = () => (
	<div className="container">
     ...
     <div className="row">
     <div className="carousel-item col-md-6 col-sm-12" align="center">
        ...
        <div className="carousel-item col-md-6 col-sm-12" align="center">
            ...
            <div className="row">
            <div className="carousel-item col-md-6 col-sm-12" align="center">
                        <p className="text-center ClientQuote">"It was a pleasing experience working together. <br/> Everything was done according to the instructions and in timely manner. Recommended!"</p>
                        ...
                        <div className="carousel-item col-md-6 col-sm-12" align="center">
                            <p className="text-center ClientQuote">"It was a pleasure working with Mirza. He did his work extremely on our WordPress theme from scratch.<br/> I'm looking forward working with him again."</p>
            ...
            <div className="carousel-item col-md-6 col-sm-12" align="center">
                    <p className="text-center ClientQuote">" The project was seamless and sounded effortless.He knows his stuff."</p>
