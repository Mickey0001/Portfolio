    ...
    <div className="container" id="workwrap">
      ...
      <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          ...
          <div className="caption">
            ...
            <p>
              <a
                href="https://dms.licdn.com/playlist/C4E05AQEiM-1NDE-aoA/mp4-720p-30fp-crf28/0/1642435046149?e=1652281200&v=beta&t=5VFQTbOqxIFVg-gl4MpXMpQuQCCiNx4LSOgztTpvSmE"
                className="btn btn-default LightGreyBackground"
                target="_blank"
                rel="noopener noreferrer"
                role="button"
      ...
      <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          <img
            className="img-responsive project"
            src={MakeE2eTestingEasierWithTheRightTools}
            alt="Make e2e Testing Easier With the Right Tools"
          />
          <div className="caption">
            <h3>E2E Testing</h3>
            <p className="DarkGreyHeading">LambdaTest - Blog</p>
            ...
            <p>
              <a
                href="https://www.lambdatest.com/blog/make-e2e-testing-easier/"
                className="btn btn-default LightGreyBackground"
                target="_blank"
                rel="noopener noreferrer"
                role="button"
