...
import MotSarajevoFirstMeetupPromoPoster from '../../../src/Images/MotSarajevoFirstMeetupPromoPoster.png';
import IntroducingTestingToNonTesters from '../../../src/Images/IntroducingTestingToNonTesters.jpg';
import TactaAcademy from '../../../src/Images/TactaAcademy.jpg';
...
const Projects = () => (
  <div className="container" id="workwrap">
    ...
    <div className="row">
      ...
      <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          <img className="img-responsive project" src={TestingAMA} alt="BuvaShop logo" />
          <div className="caption">
      ...
      {/* <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          <img className="img-responsive project" src={TactaAcademy} alt="How I started coding and found myself as Quality Assurance Engineer article" />
          <div className="caption">
            <h3>How I started coding &amp; found myself as Quality Assurance Engineer</h3>
            <p className="DarkGreyHeading">Tacta Academy</p>
            <span className="spacer"></span>
      ...
      <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          <img className="img-responsive project" src={ChallengesInTestingLegacySystems} alt="Ministry of Testing Sarajevo meetup" />
          <div className="caption">
            <h3>Challenges in Testing Legacy Systems</h3>
            <p className="DarkGreyHeading">Test Project Blog</p>
            <span className="spacer"></span>
      ...
      <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          <img className="img-responsive project" src={IntroducingTestingToNonTesters} alt="Introducing Testing To Non-Testers" />
          <div className="caption">
            <h3>Introducing Testing To Non-Testers</h3>
            <p className="DarkGreyHeading">
              Software Testing And Quality Talks</p>
            <span className="spacer"></span>
            <p><a href="https://blog.testproject.io/2021/08/16/challenges-in-testing-legacy-systems/" className="btn btn-default LightGreyBackground" target="_blank" rel="noopener noreferrer" role="button">Listen to the recording</a></p>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          <img className="img-responsive project" src={MotSarajevoFirstMeetupPromoPoster} alt="Ministry of Testing Sarajevo first meetup" />
          <div className="caption">
            <h3>First Meetup</h3>
            <p className="DarkGreyHeading">MoT Sarajevo</p>
            <span className="spacer"></span>
            <p><a href="https://www.ministryoftesting.com/dojo/lessons/mot-sarajevo-s-first-meetup" className="btn btn-default LightGreyBackground" target="_blank" rel="noopener noreferrer" role="button">Watch the recording</a></p>
          </div>
        </div>
      </div> */}
